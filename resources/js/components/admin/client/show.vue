                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">{{ client.birth_date }}</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <h6 class="my-0">CPF</h6>
                                    <small class="text-muted">{{ client.cpf }}</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <h6 class="my-0">Telefone</h6>
                                    <small class="text-muted">({{ client.area }}) {{ client.phone }}</small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">{{ client.street }}</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">{{ client.locality }}</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <h6 class="my-0">CEP</h6>
                                    <small class="text-muted">{{ client.postal_code }}</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <small class="text-muted">{{ client.complement }}</small>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <h6 class="my-0">Estado</h6>
                                    <small class="text-muted">{{ client.region_code }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-12 d-flex p-3 ml-auto justify-content-end align-items-center flex-row">
                                    ...
                                    <a :href="route('admin.clientes.edit', client.id)" class="btn bg-gradient-info m-1">
                                        Editar
                                    </a>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    >
                                        ...
                                        <template v-slot:body>
                                            ...
                                            <span class="text-xs">{{ plan.name }}</span>
