    ...
    <div class="container">
      <div class="row text-left">
        <div class="p-5 col-lg-6 col-10 mx-auto bg-light border-0 shadow-sm">
            <div class="form-row">
                <div class="form-group col-lg-12" style=""><label>Plano *</label>
            ...
            <form class="text-left">
                <div class="row">
                  <div class="form-group col-lg-6"> <label for="form19">Número do cartão *</label> <input type="text" class="form-control text-left" id="form19" placeholder="Ex: 1234 5678 9012 3456"> </div>
