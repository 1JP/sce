                ...
                <div class="card-header pb-0">
                    <div class="row">
                        ...
                        <div class="col-lg-5 d-flex justify-content-end">
                            <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal" data-bs-target="#createAndEditIndicativeModal">
                                Cadastrar
                            </button>
                        </div>
                    </div>
                            ...
                            <admin-tr>
                                ...
                                <component-td :class="'align-middle'">
                                    <component-dropdown :name="'teste'">
                                        ...
                                        <component-dropdown-item name="Excluir" target="#destroyIndicative"></component-dropdown-item>
                                    </component-dropdown>
                                </component-td>
                            </admin-tr>
                        </template>
...
<model :title="'Cadastrar Classificação Indicativa'" :name="'createAndEditIndicativeModal'">
    <div class="row">
        <div class="col-md-12">
...
<model :title="'Excluir Categoria'" :name="'destroyIndicative'">
