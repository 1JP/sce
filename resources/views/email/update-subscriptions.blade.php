                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tbody>
                                      <tr>
                                        <td valign="top" class="textContent">
                                          <!--
                                                                          ...
                                                                          -->
                                          <h1 style="color:#000000;line-height:125%;font-family:Verdana,Arial,sans-serif;font-weight:normal;margin-top:30px;margin-bottom:3px;margin-left:30px;margin-right:30px;text-align:center;">Cartão atualizado com sucesso!</h1>
                                      ...
                                      <tr>
                                        <td align="center" valign="top">
                                            <!-- FLEXIBLE CONTAINER // -->
                                            <div style="text-align:left;font-family:Verdana,Arial,sans-serif;font-size:14px;margin-bottom:10;margin-top:3px;color:#3C2E2E;line-height:135%; margin-bottom: 0px; margin-top: 20px; margin-left:30px; margin-right:30px;">Plano Atual </div>
                                            ...
                                            <div style="text-align:left;font-family:Verdana,Arial,sans-serif;font-size:14px;margin-bottom:10;margin-top:20px;color:#3C2E2E;line-height:135%;margin-bottom: 0px; margin-top: 20px; margin-left:30px; margin-right:30px;">A partir de agora, as próximas cobranças da sua assinatura serão feitas no novo cartão informado. Seus benefícios continuam os mesmos, incluindo cadastrar</div>
